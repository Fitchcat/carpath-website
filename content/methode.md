...
**Meta title** (55 car.) :  
`La méthode CARPATH | Écouter, Concevoir, Piloter, Améliorer`

**Meta description** (153 car.) :  
`Découvrez comment CARPATH travaille concrètement avec vous : 4 étapes structurées pour installer et piloter votre système de croissance. Audit gratuit disponible.`

---

## [HEADER STICKY]

- Lien 1 : La méthode *(page active)*
- Lien 2 : Le système
- Lien 3 : Pour qui ?
...
**Sous-titre :**  
Avant de concevoir quoi que ce soit, nous écoutons. Avant de piloter, nous concevons. Chaque étape a un rôle précis.
...
**Titre de l'étape :**  
Comprendre votre réalité avant de proposer quoi que ce soit
...
> 💡 C'est cette étape que vous vivez lors de votre audit gratuit.
...
**Titre de l'étape :**  
Construire votre système de croissance sur-mesure
...
**Titre de l'étape :**  
Mettre le système en marche et suivre les indicateurs
...
**Titre de l'étape :**  
Affiner en continu ce qui produit des résultats
...
**Lien secondaire :** Découvrir le CARPATH Operating System →
...
**Titre :**  
L'audit gratuit, c'est l'étape Écouter — appliquée à votre situation.

**Sous-titre :**  
30 minutes pour comprendre où vous en êtes et ce que votre système de croissance devrait couvrir en priorité — avec un premier bilan à l'oral et l'audit détaillé envoyé par écrit ensuite. Sans engagement.
